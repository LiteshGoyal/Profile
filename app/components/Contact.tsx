	...
	const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
		...
		emailjs
			.send(
				...
				{
					from_name: form.name,
					to_name: "Litesh Goyal",
					from_email: form.email,
					to_email: "liteshgoyal55@gmail.com",
	...
	return (
		<div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
			...
			>
				...
				<p className="text-gray-300 italic mt-4 ">or you can directly reach me at <span className="text-white"> liteshgoyal55@gmail.com</span></p>
			</motion.div>
			<motion.div
